...
SST_BASE_DIR = Path('/home/nico/SACO/FRESH-CARE/Data_satellite/SST/data_ease')
SSS_BASE_DIR = Path('/home/nico/SACO/FRESH-CARE/Data_satellite/SSS/sss_cci_v55/regridded_filled_wg_ease')
ADT_BASE_DIR = Path('/home/nico/SACO/FRESH-CARE/Data_satellite/AVISO/regridded/regridded_0.25_north_pole_interp_ease')
GLORYS_BASE_DIR = Path('/home/nico/SACO/FRESH-CARE/Data_reanalysis/glorys_2012_ease_woaDepths')

# Output directory
OUTPUT_DIR = Path('/home/nico/SACO/FRESH-CARE/Data_lstm_reconstruction/model_input')

# Static data files
GEBCO_FILE = '/home/nico/SACO/FRESH-CARE/Data_bathymetry/GEBCO_Sep_2025/data_EASE/gebco_ease_grid_25km.nc'
OCEAN_MASK_FILE = '/home/nico/SACO/FRESH-CARE/Arctic_masks/natural_earth_data/ne_10m_ocean_EASE_masks/ocean_mask_ease_grid_25km.nc'
...
def create_output_dataset(target_time, x_ease, y_ease, depth, grid_mapping_attrs,
    ...
    # Convert SST from Kelvin to Celsius (satellite product is in K)
    ...
    ds['T_glorys'] = xr.DataArray(
        ...
        attrs={
            ...
            'long_name': 'GLORYS Temperature (reanalysis reference)',
            'units': 'degrees_C',
            'source': 'GLORYS12V1',
            'grid_mapping': 'ease_grid_mapping'
        }
    ...
    ds['S_glorys'] = xr.DataArray(
        ...
        attrs={
            ...
            'long_name': 'GLORYS Salinity (reanalysis reference)',
            'units': 'PSU',
            'source': 'GLORYS12V1',
            'grid_mapping': 'ease_grid_mapping'
        }
    ...
    ds['SH_glorys'] = xr.DataArray(
        ...
        attrs={
            ...
            'long_name': 'GLORYS Steric Height (reanalysis reference)',
            'units': 'm',
